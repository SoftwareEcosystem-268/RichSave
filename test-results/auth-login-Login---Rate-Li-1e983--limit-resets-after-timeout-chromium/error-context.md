...
- Name: auth\login.spec.js >> Login - Rate Limiting Tests >> AUTH-LOG-302: Rate limit resets after timeout
- Location: tests\auth\login.spec.js:305:3
...
Locator: locator('text=/too many/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/too many/i')
